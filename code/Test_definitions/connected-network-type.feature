...
Feature: CAMARA Connected Network Type API, v0.2.0-rc.1 - Operation getConnectedNetworkType
  ...
  Background: Common Connected Network Type setup
    Given the resource "{api-root}/connected-network-type/v0.2rc1/retrieve" set as base-url
