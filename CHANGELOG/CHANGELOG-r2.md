...
* Delete redundant workflow files by @eric-murray in https://github.com/camaraproject/ConnectedNetworkType/pull/68
* Make lastStatusTime nullable, and add an example by @eric-murray in https://github.com/camaraproject/ConnectedNetworkType/pull/69
